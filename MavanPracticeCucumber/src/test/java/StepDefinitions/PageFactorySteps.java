...
import PageFactory.PageFactoryLoginPage;
...
public class PageFactorySteps {
	...
	public void user_enters_username_and_password(String username,String password) throws Exception {
		System.out.println("step3"); 
		 pflogin=new PageFactoryLoginPage(driver);
		pflogin.EnterUserName(username);
		pflogin.EnterPassword(password);
